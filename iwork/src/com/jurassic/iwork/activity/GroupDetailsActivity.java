...
import com.jurassic.iwork.widget.ExpandGridView;
...
public class GroupDetailsActivity extends BaseActivity implements
	...
	private RelativeLayout changeGroupDataLayout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		changeGroupDataLayout = (RelativeLayout) findViewById(R.id.rl_change_group_data);
		...
		if (group.getOwner() == null
			...
			changeGroupDataLayout.setVisibility(View.GONE);
		}
		// 如果自己是群主，显示解散按钮
		...
		changeGroupDataLayout.setOnClickListener(this);
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			case REQUEST_CODE_EDIT_GROUPNAME: // 修改群名称
				final String returnData = data.getStringExtra("groupName");
				final String returnDesc = data.getStringExtra("groupDesc");
				if (!TextUtils.isEmpty(returnData)) {
					progressDialog.setMessage("正在修改群资料...");
					progressDialog.show();
	...
	public void onClick(View v) {
		...
		case R.id.rl_change_group_data:
			startActivityForResult(
					new Intent(this, EditActivity.class).putExtra("groupName",
							group.getGroupName()).putExtra("groupDesc",
		...
		public View getView(final int position, View convertView,
			...
			if (position == getCount() - 1) {
				...
				int[] headIds = { R.drawable.head1, R.drawable.head2,
						...
						R.drawable.head12, R.drawable.head13,
						R.drawable.head14, R.drawable.head15,
						R.drawable.head16, R.drawable.head17,
						R.drawable.head18, R.drawable.head19,
						R.drawable.head20, R.drawable.head21,
						R.drawable.head22, R.drawable.head23,
						R.drawable.head24, R.drawable.head25,
						R.drawable.head26, R.drawable.head27,
						R.drawable.head28, R.drawable.head29,
						R.drawable.head30, R.drawable.head31,
						R.drawable.head32, R.drawable.head33,
						R.drawable.head34, R.drawable.head35,
						R.drawable.head36, R.drawable.head37,
						R.drawable.head38, R.drawable.head39,
						R.drawable.head40, R.drawable.head41,
						R.drawable.head42, R.drawable.head43,
						R.drawable.head44, R.drawable.head45,
						R.drawable.head46, R.drawable.head47,
						R.drawable.head48, R.drawable.head49,
						R.drawable.head50, R.drawable.head51,
						R.drawable.head52, R.drawable.head53,
						R.drawable.head54, R.drawable.head55,
						R.drawable.head56, R.drawable.head57,
						R.drawable.head58, R.drawable.head59,
						R.drawable.head60, R.drawable.head61,
						R.drawable.head62, R.drawable.head63,
						R.drawable.head64, R.drawable.head65,
				...
				if (headpic > 0 && headpic < 10000) {
					...
					BitmapDrawable avatar = new BitmapDrawable(headimg);
					avatar.setBounds(0, 0, referenceWidth, referenceHeight);
					button.setCompoundDrawables(null, avatar, null, null);
				}
