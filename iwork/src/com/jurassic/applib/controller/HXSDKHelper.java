package com.jurassic.applib.controller;
...
import com.jurassic.applib.model.DefaultHXSDKModel;
...
public abstract class HXSDKHelper {
	...
	public synchronized boolean onInit(Context context) {
		...
		if (processAppName == null
				|| !processAppName.equalsIgnoreCase("com.jurassic.iwork")) {
	...
	public void logout(final EMCallBack callback) {
		EMChatManager.getInstance().logout(new EMCallBack() {
			...
			public void onSuccess() {
				setPassword(null);// TODO 这是清空密码的节奏吗？
				if (callback != null) {
					callback.onSuccess();
				}
			}
